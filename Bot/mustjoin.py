...
PRIVATE_CHANNEL_ID = -1002711907665
PRIVATE_CHANNEL_LINK = "https://t.me/+zwbBO92AGRFjY2U1"
...
async def send_join_message(message: types.Message):
    ...
    kb.row(
        types.InlineKeyboardButton(text="📢 𝖴𝗉𝖽𝖺𝗍𝖾𝗌", url="https://t.me/+zwbBO92AGRFjY2U1"),
